...
help = telegraph.create_page(
        title='𝐏𝐮𝐛𝐥𝐢𝐜𝐋𝐞𝐞𝐜𝐡𝐂𝐥𝐨𝐧𝐞𝐆𝐫𝐨𝐮𝐩 𝐇𝐞𝐥𝐩',
...
def bot_help(update, context):
    button = ButtonMaker()
    button.buildbutton("𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞 𝐅𝐨𝐫 𝐎𝐭𝐡𝐞𝐫 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬", f"https://telegra.ph/{help}")
...
def main():
                ...
                for tag, links in data.items():
                     ...
                     for index, link in enumerate(links, start=1):
                         ...
                         if len(msg.encode()) > 4000:
                             if '𝐑𝐞𝐬𝐭𝐚𝐫𝐭𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲!' in msg and cid == chat_id:
    ...
    if ospath.isfile(".restartmsg"):
        with open(".restartmsg") as f:
            chat_id, msg_id = map(int, f)
        bot.edit_message_text("𝐑𝐞𝐬𝐭𝐚𝐫𝐭𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲!", chat_id, msg_id)
        osremove(".restartmsg")
